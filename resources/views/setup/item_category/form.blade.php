...
@include('admin.common.header')
  ...
  @if(!isset($item_category))
      {!! Form::open(['url' => 'setup/sale/stock/item_category','files'=> true,'class'=>'form-horizontal']) !!}
    @else
      {!! Form::model($item_category,['method' => 'PATCH','class'=>'form-horizontal','route'=>['setup.sale.stock.item_category.update',$item_category->id]]) !!}
    @endif
      <!-- top navigation -->
      <div class="top_nav">
         <div class="nav_menu">
           <nav class="" role="navigation">
             ...
             <div class="pull-right" style="padding-top:10px;">
              ...
              @endif
               <a data-original-title="{!! trans('common.back_to_list') !!}"  data-toggle="tooltip" data-placement="top" href="{{url('setup/sale/stock/item_category')}}" class="btn btn-default"><i class="fa fa-wa fa-reply"></i> <span class="hidden-xs">{!!trans('common.back_to_list')!!}</span></a>
      ...
      <div style="min-height: 650px;" class="right_col" role="main">
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2><i class="fa fa-pencil"></i> Item Category Form</h2>
                ...
                <div class="x_content">
                  <!-- col-sm-12 -->
                    <div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">{!! trans('setup_mgr/item_category.name') !!}:<span class="validate_label_red">*</span></label>
