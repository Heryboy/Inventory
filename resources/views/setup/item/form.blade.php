...
@include('admin.common.header')
  ...
  @if(!isset($item))
      {!! Form::open(['url' => 'setup/sale/stock/items','files'=> true,'class'=>'form-horizontal']) !!}
    @else
      {!! Form::model($item,['method' => 'PATCH','class'=>'form-horizontal','route'=>['setup.sale.stock.items.update',$item->id]]) !!}
    @endif
      <!-- top navigation -->
      <div class="top_nav">
         <div class="nav_menu">
           <nav class="" role="navigation">
             ...
             <div class="pull-right" style="padding-top:10px;">
              ...
              @endif
               <a data-original-title="{!! trans('common.back_to_list') !!}"  data-toggle="tooltip" data-placement="top" href="{{url('setup/sale/stock/items')}}" class="btn btn-default"><i class="fa fa-wa fa-reply"></i> <span class="hidden-xs">{!!trans('common.back_to_list')!!}</span></a>
      ...
      <div style="min-height: 650px;" class="right_col" role="main">
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2><i class="fa fa-pencil"></i> Item Form</h2>
                ...
                <div class="x_content">
                  <!-- col-sm-12 -->
                    <div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">{!! trans('setup_mgr/item.name') !!}:<span class="validate_label_red">*</span></label>
                    ...
                    <!--   <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                              {!! Form::select('item_category_id', $itemCategory, null, ['optional' => 'Select a user...','class'=>'form-control has-feedback-left']) !!}
                            <span class="fa fa-group form-control-feedback left" aria-hidden="true"></span>
                      </div>
                    </div>
                  ...
                  <!--     <div class="form-group">
                     ...
                     <div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">{!! trans('setup_mgr/item.alias') !!}:<span class="validate_label_red">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                     ...
                     <div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">{!! trans('setup_mgr/item.net_price') !!}:<span class="validate_label_red">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                             {!! Form::number('net_price',null,['class'=>'form-control has-feedback-left']) !!}
                            <span class="fa fa-usd form-control-feedback left" aria-hidden="true"></span>
                      </div>
                    </div>

                      <div class="form-group">
                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">{!! trans('setup_mgr/item.qty') !!}:<span class="validate_label_red">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                             {!! Form::number('qty',null,['class'=>'form-control has-feedback-left']) !!}
                            <span class="fa fa-usd form-control-feedback left" aria-hidden="true"></span>
                      </div>
                    </div>
