...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{url('assets/css/customer/header.css')}}">
   <link rel="stylesheet" type="text/css" href="{{url('assets/css/customer/order.css')}}">
  <link rel="stylesheet" type="text/css" href="{{url('assets/css/customer/footer.css')}}">
  <link rel="stylesheet" type="text/css" href="{{url('assets/css/customer/salepanel.css')}}">
  ...
  <script type="text/javascript" src="{{url('js/silentPrint.min.js')}}"></script>
...
<body>
  ...
  {{-- header --}}
  @include('POS.customer.shared.header')
  <div class="body">
    @yield('content')
  </div>
  @include('POS.customer.shared.footer')
