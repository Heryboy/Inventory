...
@section('content')	
	...
	@include('POS.salepanel._modal_order')
	...
	{{-- <div class="row"> --}}
	<div class="col-sm-7">
		@include('POS.salepanel._item_list')
	</div>

	{{-- cart-status --}}
	@include('POS.salepanel._cart_status')

	<div class="col-sm-2">
		@include('POS.salepanel._customer_select')
		<div class="clearfix"></div>
		@include('POS.salepanel._pos_function')
	</div>
	...
	<div class="col-sm-3">
		<div class="row">
			...
			<div class="pos_sidebar">
				<input name="barcode_txt" type="text" id="keyupfunction" class="form-control" style="height: 50px;" placeholder="Search barcode,name,brand" />
				...
				<section class="number_cal">
					<a id="initPay" data-toggle="modal" data-target="@if($order_id!='') .modal-pay @else .order-modal @endif" class="btn-pay btn-group btn-num" href="javascript:void(0);">
						<i class="fa fa-wa fa-money"></i><br/>
						Pay
					</a>
					...
					{{-- new order --}}
					<div class="modal fade modal-printview-invoice" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
						<div class="modal-dialog modal-lg">
						  <div class="modal-content">
						  	{{-- <center> --}}
							    <div class="modal-header">
							    ...
							    <div class="modal-bod">
							    	@include('POS.salepanel._print_invoice')
							    </div>
							    <div class="modal-footer">
							    	<button id="initPrintOutInvoice" class="btn btn-sm btn-success">Print</button>
					...
					<a id="initClear" data-toggle="modal" data-target="@if($order_id!='') .modal-cancel @else .order-modal @endif" class="btn-clear btn-group btn-num" href="javascript:void(0);">
						<i class="fa fa-wa fa-times-circle"></i><br/> Cancel
					</a>
					<a id="initDiscount" data-toggle="modal" data-target="@if($order_id!='') .modal-discount @else .order-modal @endif" class="btn-discount btn-group btn-num" href="javascript:void(0);">
						<i class="fa fa-wa fa-tag"></i><br/> Discount
					</a>
					<a id="initPrintPreview" data-toggle="modal" data-target="@if($order_id!='') ._modal-printview-invoice @else .order-modal @endif" class="btn-discount btn-group btn-num" href="javascript:void(0);">
						<i class="fa fa-wa fa-print"></i><br/> Print
					</a>
					...
					<a id="initSearch" data-toggle="modal" data-target="@if($order_id!='') ._modal-pay @else .order-modal @endif" class="btn-discount btn-group btn-num" href="javascript:void(0);">
						<i class="fa fa-wa fa-search"></i><br/> Search
					</a>
				</section>
			</div>
		</div>
	...
	@include('POS.commonjs.salepanel')
@endsection