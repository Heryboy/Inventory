    ...
    <form method="POST" action="{{ url('/auth/login') }}">
      ...
      <div id="wrapper">
        <div id="login" class="animate form">
          ...
          <center><h2 style="color:#ffffff"><b>{{SITE_NAME}}</b></h2></center>
            @if (count($errors) > 0)
          ...
          <section class="register-box login_content">
              ...
              <div>
                <button type="submit" class="btn btn-danger submit" href="{{url('schedule_monitor')}}">Log in</button>
              ...
              <div class="separator">
                ...
                <br />
                <div>
                  <p>{{FOOTER_TEXT}}. <br>Powered by <a target="_blank" href="">Samba Softwre</a></p>
                </div>
              </div>
