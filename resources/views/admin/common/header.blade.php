  ...
  <header>
    ...
    <ul class="nav navbar-nav">
      ...
      ?>
       @foreach($admin_menu as $parent_menu)
        @if(!empty($parent_menu['children_menu']))
          <li class="">
           <a href="javascript:;" class="-user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
             <i class="fa {{$parent_menu['fa_icon']}}"></i> {{$parent_menu['parent_menu_name']}}
             {{-- <span class=" fa fa-angle-down"></span> --}}
           </a>
           <ul class="-dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
            @foreach($parent_menu['children_menu'] as $child_menu)
              <li><a href="{{url('/')}}/{{$child_menu['c_menu_link']}}"> {!! $child_menu['child_menu_name'] !!}</a>
              </li>
            @endforeach
           </ul>
          </li>
        @else
          <li class=""><a href="{{url('/')}}/{{$parent_menu['p_menu_link']}}"><i class="fa <?php echo $parent_menu['fa_icon'];?>"></i> <?php echo $parent_menu['parent_menu_name'];?></a></li>
        @endif
       @endforeach

       <li class="">
        <a href="javascript:;" class="-user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
        <i class="fa {{$parent_menu['fa_icon']}}"></i> All
        {{-- <span class=" fa fa-angle-down"></span> --}}
        </a>
            ...
            @if(!empty($parent_menu['children_menu']))
              <li class="sub_group_li">
               <a href="javascript:;" class="-user-profile -dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                 ...
                 <ul class="sub_ulover">
                  @foreach($parent_menu['children_menu'] as $child_menu)
                    <li class="sublist_hover"><a href="{{url('/')}}/{{$child_menu['c_menu_link']}}"> {!! $child_menu['child_menu_name'] !!}</a>
                    </li>
                  @endforeach
                 </ul>
              </li>
            @else
              <li><a href="{{url('/')}}/{{$parent_menu['p_menu_link']}}"><i class="fa <?php echo $parent_menu['fa_icon'];?>"></i> <?php echo $parent_menu['parent_menu_name'];?></a></li>
            @endif
           @endforeach
        </ul>
      </li>
     ...
     <!--  <li class="pull-left">
       <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
         <img width="20px" src="{{url('/images/uploads/user')}}/{{Auth::user()->photo}}" alt="">{{Auth::user()->username}}
         <span class=" fa fa-angle-down"></span>
       </a>
       <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li>
        <a href="{{url('auth/logout')}}"><i></i> <span class="glyphicon glyphicon-off" aria-hidden="true"></span> Logout</a>
      </li>
    </ul>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav">
          ...
          <!-- @foreach($top_menu as $menu)
            <li><a href="{{url('')}}/{{$menu['p_menu_link']}}"><i class="fa {{$menu['fa_icon']}}"></i> {{$menu['parent_menu_name']}}</a></li>
          @endforeach -->
        </ul>
