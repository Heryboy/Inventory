...
<body>  
    <div class="contain-invoice">
        ...
        <div class="bill-info">
            ...
            <div class="general-info">
                <span class="pull-left">
                    <div class="invoice-no">{{ $SaleOrders['sale_order_no'] }}</div>
                </span>
                <span class="pull-right">
        ...
        <table id="table-row">
                ...
                @if(isset($SaleOrderDetails))
                    @foreach($SaleOrderDetails as $row)
                        <tr>
                            ...
                            <td>{{ $row->remark }}</td>
                            <td>{{Helpers::FormatCurrentcy($row->sale_order_price,'$')}}</td>
                            <td>{{$row->sale_order_qty}}</td>
                            <td>{{Helpers::FormatCurrentcy($row->sale_order_price * $row->sale_order_qty,'$')}}</td>
                        </tr>
                    @endforeach
               @endif
            </tbody>
            ...
            <tfoot>
                <tr>
                    ...
                    <td><span class="pull-right"><span id="p_amount_sub_total"></span> {{Helpers::FormatCurrentcy($SaleOrders['sub_total'],'$')}}</span></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="2">Tax</td>
                    <td><span class="pull-left"></span> <span class="pull-right">{{Helpers::FormatCurrentcy($SaleOrders['tax'],'$')}}</span></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="2">Discount</td>
                    <td><span class="pull-left"></span> <span class="pull-right"><span id="p_discount_total"></span>{{Helpers::FormatCurrentcy($SaleOrders['discount'],'$')}}</span></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="2">Total </td>
                    <td><span class="pull-right"><span id="p_amount_total" class="pull-right amount_total"></span> {{Helpers::FormatCurrentcy($SaleOrders['grand_total'],'$')}}</span></td>
                </tr>
            </tfoot>
        </table>
        <br/>
