    ...
    <div style="min-height: 650px;" class="right_col" role="main">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Languages <small>(Languages)</small></h2>
              ...
              <table class="table table-striped responsive-utilities jambo_table bulk_action">
                ...
                <tbody>
                  <tr class="even pointer">
                    ...
                    <td class=" ">01</td>
                    <td class=" "><img src="{{url('images/flag/khm.png')}}"></td>
                    <td class=" ">Khmer</td>
                    <td>KH</td>
                    <td class=" ">1</td>
                    <td class=" ">Active</td>
                    <td class=" ">
                      ...
                      <button class="btn btn-xs btn-primary"><i class="fa fa-wa fa-pencil"></i></button> 
                      <button class="btn btn-xs btn-danger"><i class="fa fa-wa fa-trash"></i></button>
                    </td>
                  </tr>
                  <tr class="odd pointer">
                    ...
                    <td class=" ">01</td>
                    <td class=" "><img src="{{url('images/flag/en.png')}}"></td>
                    <td class=" ">English</td>
                    <td>EN</td>
                    <td class=" ">1</td>
                    <td class=" ">Active</td>
