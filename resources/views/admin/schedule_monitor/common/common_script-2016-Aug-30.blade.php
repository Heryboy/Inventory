...
<script type="text/javascript">
		...
		$.getLayoutTime = function(data,distance_between_utc,bevious_distance,bevious_aircraft,new_date,total_distance){ 
					...
					if(new_date==(schedule_data.schedule_date)){
							...
							html_right_click_status += '<div style="position:absolute;margin:0 auto;left:0;right:0;top:15px;font-size:25px;z-index:100;">';
								...
								html_right_click_status += '</center>';
									...
									html_right_click_status += '<div style="position:absolute;margin:0 auto;left:0;right:0;top:0px;font-size:15px;margin:0 auto;">';
										// html_right_click_status += '<center>';
										// html_right_click_status += '<div class="flight_information" id="flight_pax_main_UTC'+schedule_data.fsm_id+'">';
													...
													html_right_click_status +='<div class="col-sm-12">';
														html_right_click_status += '<div class="row">'; 
															...
															html_right_click_status += '<div class="" role="tabpanel" data-example-id="togglable-tabs">';
																...
																// html_right_click_status += '<div class="col-sm-6" style="padding:4px;font-size:13px;">';
																//   html_right_click_status += '<a class="btn btn-xs btn-primary" href="javascript:void();"><i class="fa fa-wa fa-plane"></i> Change Aircraft</a>';
																// html_right_click_status += '</div>';
						...
						html += '<div class="schedule_UTC_content" style="display: block;position: relative;top:'+class_cal_hour+'px;left:3px;">';
							...
							switch(flight_status_id) {
								...
								// 		if(STD_Time>2000){
								// 			var cal_distance_cal = schedule_data.distance_utc-1050;
								// 		}else{
								// 			var cal_distance_cal = schedule_data.distance_utc+(3*50);
								// 		}
								// 	@else
								// 		var cal_distance_cal = distance_utc;
								// 	@endif
								...
								// 			html += '<div style="margin-left:'+cal_distance_cal+'px;">';
								...
								// 		}else if(schedule_data.pm_color!=null){
								...
								// 			// group-flight
								// 			// html += '<div class="group-flight" style="position:relative;bottom:-23px;font-size:10px;">';
								...
								// 						// html += '<div class="initSwapAction" data-value="'+schedule_data.fsm_id+'" style="position:absolute;background-color:'+schedule_data.update_status_color+';height:15px;width:'+schedule_data.etimate_time_utc+'px;top:-15px;">';
								// 							// Swap Flight

								// 							html += '<div data-value="'+schedule_data.fsm_id+'" class="initSwapAction flight-status-bg" style="position:absolute;background-color:'+color_transform+';height:15px;width:'+schedule_data.etimate_time_utc+'px;top:-15px;">';
								...
								// case 33:
								// 	var divert_origin = '';
								// 	var divert_destination = '';

								// 	// alert(schedule_data.fsh_STA);
								// 	// alert(schedule_data.fsh_STD);

								// 	$.each(schedule_data['flight_schedule_history_arr'],function(index,fsh_data){

								// 		divert_origin = fsh_data.fsh_origin_name;
								// 		divert_destination = fsh_data.fsm_destination_name;
								...
								// 			// this formular happen when use get print schedule
								// 			if(STD_Time>2000){
								// 				var cal_distance = fsh_data.distance_utc_divert-1050;
								// 			}else{
								// 				var cal_distance = fsh_data.distance_utc_divert+(3*50);
								// 			}

								// 			html += '<div class="schedule_inner" style="margin-left:'+
								// 				cal_distance+'px;">'
								// 		@else
								// 			html += '<div class="schedule_inner" style="margin-left:'+fsh_data.distance_utc_divert+'px;">'
								// 		@endif

								// 		// Schedule Innner
								// 		html  += '<div style="position:absolute;z-index:100;" class="checkflightSchedule" data-value='+fsh_data.fsm_id+'>';
								// 			html += '<input style="display:none;" type="checkbox" class="-hidden-lg" value="'+fsh_data.fsm_id+'=>'+schedule_data.schedule_date+'=>'+schedule_data.aircrafts_id+'=>'+schedule_data.origin_id+'=>'+schedule_data.destination_id+'=>'+schedule_data.fsm_STA+'=>'+schedule_data.fsm_STD+'=>:'+total_distance+'=>" id="flight_schdule_check'+schedule_data.fsm_id+'" name="flight_schedule_mgr[]">';
								// 		html += '</div>';
								...
								// 			// group-flight
								// 			html += '<div id="contextMenuOption" class="contextMenuOption group-flight" data-value="'+fsh_data.fsm_id+'" style="position:relative;bottom:-23px;font-size:10px;">';

								// 				// block background
								// 				html += '<a class="check_schedule" onClick="InitFlightPax_UTC('+fsh_data.fsm_id+')" href="javascript:void();">';
								// 					// normal Flight
								// 					html += '<label for="flight_schdule_check'+fsh_data.fsm_id+'" style="position:absolute;">';
								// 						// initSwapAction
								// 						html += '<div class="flight-status-bg" data-value="'+fsh_data.fsm_id+'" style="position:absolute;background-color:'+color_transform+';height:15px;width:'+fsh_data.etimate_time_utc_divert+'px;top:-15px;">';
								...
								// 								// 
								// 								html +='<div style="right:100%;position:absolute;top:14px;">';
								// 									if(fsh_data.STD_minute==0){
								// 										html += '00';
								// 									}else if(fsh_data.STD_minute<=9){
								// 										html += '0'+fsh_data.STD_minute;
								// 									}else{
								// 										html += fsh_data.STD_minute;
								// 									}
								// 								html += '</div>';
								...
								// 										html += '<small style="background:yellow;cursor: pointer;font-size:10px !important">'+fsh_data.calculate_dt_schedule_time+'</small>';
								// 									html += '</center>';
								// 								html += '</div>';
								...
								// 								// flight_notification_status ######################
								// 								// html += html_notificaton;
								// 								html += $.LeftClickNotification(fsh_data.fsm_id,fsh_data.fsh_origin_name,fsh_data.fsh_destination_name,fsh_data.fsh_aircraft_name,fsh_data.STD,fsh_data.STA,schedule_data.created_by_user,fsh_data.created_date,fsh_data.crews_arr,divert_BT_OFF,divert_BT_ON,fsh_data.adult,fsh_data.child,fsh_data.enfant,fsh_data.first_class,fsh_data.business_class,fsh_data.economic_class,fsh_data.cargo,fsh_data.pax_movement_id,fsh_data.block_fuel,fsh_data.used_fuel,fsh_data.distance_utc_divert,fsh_data.fsm_flight_group,fsh_data.fsm_remark,fsh_data.fsm_fnotification_status_id,fsh_data.schedule_date,fsh_data.flight_status_id,total_distance,STD_hour,fsh_data.modified_by_user,retime_std,retime_sta,retime_remark,fsh_data.origin_id,fsh_data.destination_id,fsh_data.fsm_modified_date,fsh_data.aircraft_id,reschedule_std,reschedule_sta,reschedule_remark,delay_std,delay_sta,delay_remark,divert_remark,divert_dtd,divert_dta,divert_std,divert_sta,divert_location,fsh_data.fsm_ATA,fsh_data.fsm_ATD,actual_time_ata,fsh_data.flight_schedule_id,fsh_data.fsh_remark);
								// 								// block_right_click
								// 								// html += html_right_click_status;
								// 								html += $.RightClickNotification(fsh_data.fsm_id,fsh_data.flight_status_id,fsh_data.schedule_date,total_distance);

								// 								// #############END flight_notification_status  ######
								// 									// Destination Block
								// 									html +='<div style="left:100%;position:absolute;">';
								// 										html += fsh_data.fsh_destination_name;
								// 										// html += divert_destination;
								// 									html +='</div>';
								// 								html +='<div style="left:100%;position:absolute;top:14px;">';
								// 									if(fsh_data.STA_minute==0){
								// 										html += '00';
								// 									}else if(fsh_data.STA_minute<=9){
								// 										html += '0'+fsh_data.STA_minute;
								// 									}else{
								// 										html += fsh_data.STA_minute;
								// 									}
								// 								html += '</div>';
								// 								// ###END condition if flight_status is Delay Flight ####
								// 							html +='</div>';
								...
								// 		// this formular happen when use get print schedule
								// 		if(STD_Time>2000){
								// 			var cal_distance = distance_utc-1050;
								// 		}else{
								// 			var cal_distance = distance_utc+(3*50);
								// 		}
								// 	@else
								// 		var cal_distance = distance_utc;
								// 	@endif

								// 	// check flag is this status is cancelled flight ########
								// 	if(schedule_data.flight_status_id!=flag_cancelled_flight){
								// 		if(schedule_data.fsm_ATD!=null || schedule_data.fsm_ATA!=null){
								// 			// this line grid time will appear when schedule is complete
								// 			html += '<div style="margin-left:'+cal_distance+'px;">';
								...
								// 			html += '<a onClick="InitFlightPax_UTC('+schedule_data.fsm_id+')" href="javascript:void();">';
								// 				// normal Flight
								// 				html += '<div class="flight-status-bg" style="position:absolute;background-color:'+color_transform+';height:15px;width:'+schedule_data.etimate_time_utc+'px;top:-15px;">';
								...
								default:
									...
									@endif
										...
										// html += '<div id="demo2RightBtn" data-value="xu-12" class="btn ">Menu on right click</div>';
										//   html += '</div>';
										// html += '</div>';
										// if(schedule_data.pm_color!=null){
										//   // color_transform = schedule_data.pm_color;
										//   if (current_date.toDateString() < start.toDateString()) {
										//     color_transform = schedule_data.pm_color;
										//   }else{
										//     color_transform = color_not_update;
										//   }
										...
										if(schedule_data.schedule_date<capture_current_date && actual_time_atd==null){
											...
											// local_hour = local_current_date.getHours();
											if(trimmedString < local_hour){
												// default utc time - 7
												if((local_hour-7)<=STD_hour){
													// color_transform = schedule_data.update_status_color;
													color_transform = schedule_data.flight_status_color;
													flight_status_bg = 'flight-status-bg';
												}else{
														...
														html +='<div class="block-flight-no">';
															...
															if(swap_action!=0){
																if(write_permission_sm==1){
																	...
																	html += $.getLayoutPopupTabDelayFlight(fsm_id,origin_id,origin_name,destination_id,destination_name,STD_DELAY,STA_DELAY,fsm_STD,fsm_STA,remark_DELAY,flag_delay_flight,total_distance,schedule_date,flight_status_id_DELAY,local_hour,STD_hour_DELAY,aircraft_id,modified_by_DELAY,modified_date_DELAY,capture_current_date);
																	...
																	html += $.getLayoutPopupTabRescheduleFlight(fsm_id,origin_id,origin_name,destination_id,destination_name,STD_RESCHEDULE,STA_RESCHEDULE,fsm_STD,fsm_STA,remark_RESCHEDULE,flag_reschedule_flight,total_distance,schedule_date,flight_status_id_RESCHEDULE,local_hour,STD_hour_RESCHEDULE,aircraft_id,modified_by_RESCHEDULE,modified_date_RESCHEDULE,capture_current_date);
			...
			$.RightClickNotification = function(fsm_id,flight_status_id,schedule_date,total_distance){
				...
				html_right_click_status += '<div style="position:absolute;margin:0 auto;left:0;right:0;top:15px;font-size:25px;z-index:100;">';
					...
					html_right_click_status += '</center>';
						...
						html_right_click_status += '<div style="position:absolute;margin:0 auto;left:0;right:0;top:0px;font-size:15px;margin:0 auto;">';
							// html_right_click_status += '<center>';
							// html_right_click_status += '<div class="flight_information" id="flight_pax_main_UTC'+fsm_id+'">';
									...
									html_notificaton +='<div class="col-sm-12">';
										html_notificaton += '<div class="row">'; 
											...
											html_notificaton += '<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">';
												...
												// html_notificaton += '<li role="presentation" class=""><a href="#tab_swap_flight'+schedule_data.fsm_id+'" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">{!!trans("flightschedule/schedulemonitor.swap_flight")!!}</a></li>';
												...
												// html_notificaton += '<li role="presentation" class=""><a href="#tab_requested_flight'+fsm_id+'" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">{!!trans("flightschedule/schedulemonitor.requested_flight")!!}</a></li>';
											...
											html_notificaton += '<div class="group-whole col-sm-4">';
													...
													html_notificaton += '<div class="form-group">';
														...
														html_notificaton += '<label class="control-label col-sm-5" for="">{!!trans("flightschedule/schedulemonitor.block_off")!!} </label>';
															...
															html_notificaton += '<div class="col-sm-7">';
																...
																html_notificaton += '<input maxlength="4" value="'+BT_OFF+'" placeholder="{!!trans("flightschedule/schedulemonitor.block_off")!!}" data-parsley-id="0098" name="block_off'+fsm_id+'" id="block_off'+fsm_id+'" class="form-control col-md-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
												...
												html_notificaton += '<div class="group_atd_'+fsm_id+'"">';
													html_notificaton += '<div class="form-group">';
														...
														html_notificaton += '<label class="control-label col-sm-5" for="">{!!trans("flightschedule/schedulemonitor.atd")!!} <span class="validate_label_red">*</span></label>';
															...
															html_notificaton += '<input placeholder="ATD" data-parsley-id="0098" name="fsm_atd'+fsm_id+'" id="fsm_atd'+fsm_id+'" maxlength="4" value="'+actual_time_atd+'" required="required" class="form-control col-md-12 col-xs-12" type="text"></div>';
												...
												html_notificaton += '<div class="group_ata_'+fsm_id+'"">'; 
													html_notificaton += '<div class="form-group">';
														...
														html_notificaton += '<div class="col-md-7 col-sm-7 col-xs-12"><input placeholder="ATA" maxlength="4" data-parsley-id="0098" name="fsm_ata'+fsm_id+'" id="fsm_ata'+fsm_id+'" value="'+actual_time_ata+'" class="form-control col-md-12 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton+='</div>';
												html_notificaton += '</div>';
												// #END form group 
													...
													html_notificaton += '<div class="group_block_on'+fsm_id+'">';
														html_notificaton += '<label class="control-label col-md-5 col-sm-5 col-xs-12" for="">{!!trans("flightschedule/schedulemonitor.block_on")!!} </label>';
															html_notificaton += '<div class="col-md-7 col-sm-7 col-xs-12">';
																...
																html_notificaton += '<input value="'+BT_ON+'" maxlength="4" placeholder="{!!trans("flightschedule/schedulemonitor.block_on")!!}" data-parsley-id="0098" name="block_on'+fsm_id+'" id="block_on'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
													...
													html_notificaton += '<div class="group_adult'+fsm_id+'">';
														html_notificaton += '<label class="control-label col-md-3 col-sm-3 col-xs-12" for="">{!!trans("flightschedule/schedulemonitor.text_adult")!!} </label>';
															html_notificaton += '<div class="col-md-9 col-sm-9 col-xs-12">';
																...
																html_notificaton += '<input value="'+adult+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_adult")!!}" data-parsley-id="0098" name="adult'+fsm_id+'" id="adult'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
												// #End form-group
												...
												html_notificaton += '<div class="form-group">';
													html_notificaton += '<div class="group_child'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-9 col-sm-9 col-xs-12">';
															...
															html_notificaton += '<input value="'+child+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_child")!!}" data-parsley-id="0098" name="child'+fsm_id+'" id="child'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
												// #End form-group
												...
												html_notificaton += '<div class="form-group">';
													html_notificaton += '<div class="group_enfant'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-9 col-sm-9 col-xs-12">';
															...
															html_notificaton += '<input value="'+enfant+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_enfant")!!}" data-parsley-id="0098" name="enfant'+fsm_id+'" id="enfant'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
												// #End form-group
												...
												html_notificaton += '<div class="form-group">';
													html_notificaton += '<div class="group_f'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-9 col-sm-9 col-xs-12">';
															...
															html_notificaton += '<input value="'+first_class+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_first_class")!!}" data-parsley-id="0098" name="first_class_'+fsm_id+'" id="first_class_'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';  
												html_notificaton += '</div>';
												// #End form-group
												...
												html_notificaton += '<div class="form-group">';
													...
													html_notificaton += '<div class="group_c'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-9 col-sm-9 col-xs-12">';
															...
															html_notificaton += '<input value="'+business_class+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_business_class")!!}" data-parsley-id="0098" name="business_class_'+fsm_id+'" id="business_class_'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												...
												html_notificaton += '<div class="form-group">';
													...
													html_notificaton += '<div class="group_y'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-9 col-sm-9 col-xs-12">';
															...
															html_notificaton += '<input value="'+economic_class+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_economic_class")!!}" data-parsley-id="0098" name="economic_class_'+fsm_id+'" id="economic_class_'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
												// #End form-group
												...
												html_notificaton += '<div class="form-group">';
													html_notificaton += '<div class="group_cargo'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-7 col-sm-7 col-xs-12">';
															...
															html_notificaton += '<input value="'+cargo+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_cargo")!!}" data-parsley-id="0098" name="cargo'+fsm_id+'" id="cargo'+fsm_id+'" class="form-control col-md-12 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';  
												html_notificaton += '</div>';
												// #End Cargo
												...
												html_notificaton += '<div class="form-group">';
													...
													html_notificaton += '<div class="group_block_fuel'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-7 col-sm-7 col-xs-12">';
															...
															html_notificaton += '<input value="'+block_fuel+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_block_fuel")!!}" data-parsley-id="0098" name="block_fuel'+fsm_id+'" id="block_fuel'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
												// #End Block Fuel
												...
												html_notificaton += '<div class="form-group">';
													...
													html_notificaton += '<div class="group_used_fuel'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-7 col-sm-7 col-xs-12">';
															...
															html_notificaton += '<input value="'+used_fuel+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_used_fuel")!!}" data-parsley-id="0098" name="used_fuel'+fsm_id+'" id="used_fuel'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
												// #End BLock Used Fuel
												...
												html_notificaton += '<div class="form-group">';
													...
													html_notificaton += '<div class="group_distance'+fsm_id+'">';
														...
														html_notificaton += '<div class="col-md-7 col-sm-7 col-xs-12">';
															...
															html_notificaton += '<input value="'+distance+'" placeholder="{!!trans("flightschedule/schedulemonitor.text_distance")!!}" data-parsley-id="0098" name="distance'+fsm_id+'" id="distance'+fsm_id+'" class="form-control col-md-7 col-xs-12" type="text">';
														html_notificaton += '</div>';
													html_notificaton += '</div>';
												html_notificaton += '</div>';
												// #End BLock Distance
			...
			$.getLayoutPopupTabCancelFlight = function(fsm_id,origin_id,origin_name,destination_id,destination_name,std,sta,fsm_STD,fsm_STA,remark,flag_cancelled_flight,total_distance,schedule_date,flight_status_id,local_hour,STD_hour,aircraft_id,modified_by,modified_date,capture_current_date,aircraft_name,pax_movement_id,fsm_flight_group){
			...
			$.getLayoutPopupTabDeleteFlight = function(fsm_id,origin_id,origin_name,destination_id,destination_name,std,sta,fsm_STD,fsm_STA,remark,flag_deleted_flight,total_distance,schedule_date,flight_status_id,local_hour,STD_hour,aircraft_id,modified_by,modified_date,capture_current_date,aircraft_name){
				var html_notificaton='';
			...
			$.getLayoutPopupTabRetimeFlight = function(fsm_id,origin_id,origin_name,destination_id,destination_name,std,sta,fsm_STD,fsm_STA,remark,flag_retime_flight,total_distance,schedule_date,flight_status_id,local_hour,STD_hour,aircraft_id,modified_by,modified_date,capture_current_date){
			...
			$.getLayoutPopupTabDelayFlight = function(fsm_id,origin_id,origin_name,destination_id,destination_name,std,sta,fsm_STD,fsm_STA,remark,flag_delay_flight,total_distance,schedule_date,flight_status_id,local_hour,STD_hour,aircraft_id,modified_by,modified_date,capture_current_date){
				var html_notificaton_str='';
				html_notificaton_str += '<div class="col-sm-12" style="padding-top:10px;"><button type="button" data-original-title="{!!trans("flightschedule/schedulemonitor.button_save_chage")!!}" data-toggle="tooltip" data-placement="top" onClick="disableAction();" class="btn btn-success btn-md">{!!trans("flightschedule/schedulemonitor.button_save_chage")!!}</button></div>';
			...
			// getLayoutPopupTabRescheduleFlight
			$.getLayoutPopupTabRescheduleFlight = function(fsm_id,origin_id,origin_name,destination_id,destination_name,std,sta,fsm_STD,fsm_STA,remark,flag_reschedule_flight,total_distance,schedule_date,flight_status_id,local_hour,STD_hour,aircraft_id,modified_by,modified_date,capture_current_date){
		...
		$.eventallData = function(event){
			...
			$(".droppable").droppable({
				...
				drop: function() { 
					...
					// <!-- draggable_text -->
					// <input type="text" name="draggable_aircraft" id="draggable_aircraft">
					// <input type="text" name="draggable_fsm_id" id="draggable_fsm_id">
				}
			});
