      ...
      <div style="min-height: 650px;" class="right_col" role="main">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                <h2>{!!trans('notification/notification.all_notifications')!!}</h2>
              ...
              <div class="row">
                ...
                <div class="x_content">
                  ...
                  <table id="example1" class="table table-bordered table-striped dataTable">
                    <thead>
                      <tr>
                        <th>{!!trans('notification/notification.no')!!}</th>
                        <th>{!!trans('notification/notification.notifications')!!}</th>
                        <th>{!!trans('notification/notification.date_added')!!}</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php $i=1;?>
                      @foreach($notifications as $notification)
                        <tr>
                          <td>{{$i}}</td>
                          <td><a target="_blank" href="{{url('')}}/{{$notification->url}}"> {{$notification->notification_name}}</a></td>
                          <td><center>{{Helpers::FormatDateTime($notification->date_added)}}</center></td>
                        </tr>
                        <?php $i++;?>
                      @endforeach
                    </tbody>
