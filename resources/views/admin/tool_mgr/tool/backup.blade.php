           ...
           <div class="nav_menu">
             <nav class="" role="navigation">
               ...
               <div class="pull-right" style="padding-top:10px;">
                <!-- action top -->
                <button type="submit" form="form-backup" data-toggle="tooltip" title="Export" class="btn btn-primary"><i class="fa fa-download"></i> {!!trans('tool_mgr/backup.export')!!}</button>
                <button type="submit" form="form-restore" data-toggle="tooltip" title="Import" class="btn btn-primary"><i class="fa fa-upload"></i> {!!trans('tool_mgr/backup.import')!!}</button>
        ...
        <div style="min-height: 650px;" class="right_col" role="main">
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="x_panel">
                <div class="x_title">
                  <h2>{!!trans('tool_mgr/backup.import')!!}/{!!trans('tool_mgr/backup.export')!!}</h2>
                  ...
                  <div class="x_content">
                    ...
                    {!! Form::open(['url' => 'admin/tool_mgr/restore','files'=> true,'class'=>'form-horizontal','id' => 'form-restore']) !!}
                      ...
                      <div class="form-group">
                        <div class="form-group">
                          <label class="col-sm-2 control-label" for="input-import">{!!trans('tool_mgr/backup.import')!!}</label>
                          <div class="col-sm-10">
