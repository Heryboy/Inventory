...
<script type="text/javascript">
  ...
  $.purchaseDataAttribute = function(attribute_row){
    var html = '';
     html +='<tr id="attribute-row-item'+attribute_row+'">';
      ...
      // html +='<td id="group_total'+attribute_row+'">{!! Form::text("total[]",null,["class"=>"form-control total","placeholder"=>trans("stock_mgr/purchase_order.entry_price_total")]) !!}</td>';
  ...
  function global_grandTotal(){
    ...
    var vat_txt = $("input[name='vat_percentage']").val();
    ...
    if(vat_txt!=""){
      vat = $("input[name='vat_percentage']").val();
    }else{
      vat = 0;
    }
  ...
  $(".item_id").change(function(){
    var attribute_row = $(this).data('id');
    $.getItem(attribute_row);
  });
