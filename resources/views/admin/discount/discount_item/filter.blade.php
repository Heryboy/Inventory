...
<div class="group-filter">
  <div class="row padding-top">
    ...
    <div class="col-sm-9">
      <div class="row">
        <div class="col-sm-12">
          <form method="patch" id="form-search" action="">
            <div class="col-sm-4">
    ...
    <div class="col-sm-3">
      <span class="pull-right">
        <a class="btn btn-sm btn-primary" href="{{url('admin/discount/discount_item')}}"><i class="fa fa-wa fa-reply"></i> {{trans('discount/discount_item.back_to_list')}}</a>
        <button form-id="form-discountitem" type="submit" class="btn btn-sm btn-success"><i class="fa fa-wa fa-save"></i> {{trans('item_mgr/item_base_store.save')}}</button>
