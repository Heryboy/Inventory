          ...
          <div class="row">
            <div class="col-md-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <div class="row">
                    <center><div style="font-weight: bold;font-size:20px;">{!!trans('stock_mgr/purchase_order.entry_invoice')!!}</div></center>
                  </div>
                </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <form class="form-horizontal form-label-left input_mask">
                          ...
                          <div class="-form-group">
                            <label class="-control-label col-md-4 col-sm-4 col-xs-12 pull-left"> {!!trans('stock_mgr/purchase_order.entry_supplier')!!}</label>
                            <div class="col-md-7 col-sm-7 col-xs-12 form-group has-feedback">
                              {!! Form::select('supplier_id', $Suppliers, null, ['placeholder' => trans('stock_mgr/purchase_order.choose_supplier'),'id'=>'supplier_id','class'=>'form-control']) !!}
                            </div>
                          </div>
