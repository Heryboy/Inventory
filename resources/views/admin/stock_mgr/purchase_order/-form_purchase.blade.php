                        ...
                        <form class="form-horizontal form-label-left input_mask">
                          ...
                          <div class="-form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 form-group has-feedback">
                              {!! Form::text('item_barcode',null,['class'=>'date-picker form-control has-feedback-left','placeholder'=>trans("stock_mgr/purchase.entry_invoice_date")]) !!}
                          ...
                          <div class="-form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 form-group has-feedback">
                              {!! Form::select('supplier_id', $Suppliers, null, ['placeholder' => trans('stock_mgr/purchase.choose_supplier'),'id'=>'supplier_id','class'=>'form-control']) !!}
                            </div>
                          </div>
                          ...
                          <table class="table table-bordered table-striped dataTable">
                            <tbody>
                              <tr>
                                ...
                                <td><input type="text" class="pull-left" value="0.00" disabled="" name="sub_total"></td>
                              </tr>
                              <tr>
                                <th>Shipping:</th>
                              ...
                              <tr>
                                <td><label><input type="checkbox" class="flat" name="is_vat"> Include Vat</label></td>
                                <td><label><input type="checkbox" class="flat" name="is_approve"> Approved</label></td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
...
<script type="text/javascript">
  ...
  function addItem() {
    ...
    html +='<tr id="attribute-row-item'+attribute_row+'">';
      html +='<td><div id="group_barcode'+attribute_row+'">';
        html += '<input name="attribute_data['+attribute_row+'][barcode]" id="item_barcode" type="text" class="form-control" placeholder="{!!trans("stock_mgr/purchase.entry_barcode")!!}">';
      html += '</div></td>';
      html +='<td width="150px">';
        html += '<div id="group_item'+attribute_row+'">{!! Form::select("attribute_data[]", $Items, null, ["placeholder" => trans("stock_mgr/purchase.choose_item"),"id"=>"item_id","class"=>"form-control"]) !!}</div>';
      html +='</td>';
      html +='<td width="150px">';
        html += '<select class="form-control" id="unit" name="attribute_data['+attribute_row+'][unit_id]">';
          html += '<option>{!!trans("stock_mgr/purchase.choose_unit")!!}</option>';
      ...
      html +='<td><div id="group_price_dollar'+attribute_row+'"><input name="attribute_data['+attribute_row+'][price_dollar]" onblur="setPrice(' + attribute_row + ');" id="setPrice" type="text" class="form-control" placeholder="{!!trans("stock_mgr/purchase.entry_price_dollar")!!}"></div></td>';

      html +='<td><div id="group_price_reil'+attribute_row+'">';

        html += '<input name="attribute_data['+attribute_row+'][price_reil]" disabled="disabled" id="item_barcode" type="text" class="form-control" placeholder="{!!trans("stock_mgr/purchase.entry_price_reil")!!}">';

      html += '</div></td>';

      html +='<td id="group_qty'+attribute_row+'">';
        html += '<input name="attribute_data['+attribute_row+'][qty]" onblur="setTotal(' + attribute_row + ');" type="text" class="form-control" placeholder="{!!trans("stock_mgr/purchase.entry_price_quantity")!!}">';
      html += '</td>';

      html +='<td id="group_discount'+attribute_row+'">';
        html += '<input name="attribute_data['+attribute_row+'][discount_amount]" onblur="setDiscount(' + attribute_row + ');" type="text" class="form-control" placeholder="{!!trans("stock_mgr/purchase.entry_price_discount")!!}">';
      html += '</td>';

      html +='<td id="group_total'+attribute_row+'">'
        html += '<input name="attribute_data['+attribute_row+'][total]" id="total" type="text" class="form-control" placeholder="{!!trans("stock_mgr/purchase.entry_price_total")!!}">';
      html += '</td>';

      html +='<td>';
        html += '<input name="attribute_data['+attribute_row+'][remark]" id="total" type="text" class="form-control" placeholder="{!!trans("stock_mgr/purchase.entry_price_remark")!!}">';
      html += '</td>';
  ...
  function global_grandTotal(){
    ...
    shipping_txt = $("input[name='shipping']").val();
    sub_discount_txt = $("input[name='sub_discount']").val();
    vat_txt = $("input[name='vat_amount']").val();
    ...
    // dynamic text sum
    $("input[name='attribute_data["+attribute_row+"][total]']").each(function () {
  ...
  function global_cal(attribute_row){
    ...
    var price_item = $("#group_price_dollar"+attribute_row+" input[name='attribute_data["+attribute_row+"][price_dollar]']").val();

    var cal_price_reil = parseFloat(price_item) * parseFloat(exchange_rate);
    $("#group_price_reil"+attribute_row+" input[name='attribute_data["+attribute_row+"][price_reil]']").val(cal_price_reil);

    // Quantity
    var item_qty = $("#group_qty"+attribute_row+" input[name='attribute_data["+attribute_row+"][qty]']").val();
    total = parseFloat(price_item)*parseFloat(item_qty);

    // discount
    var discount = $("#group_discount"+attribute_row+" input[name='attribute_data["+attribute_row+"][discount_amount]']").val();
    if(discount>0){
      total = parseFloat(total)-parseFloat(discount);
    }

    $("#group_total"+attribute_row+" input[name='attribute_data["+attribute_row+"][total]']").val(total);
