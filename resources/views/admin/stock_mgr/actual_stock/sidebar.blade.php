...
<div class="left_col scroll-view">
  ...
  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">   
    <div class="menu_section">
     ...
     <div class="lbl-cat">
      <h3 class="lbl-focus active">Actual Stock</h3>
     </div>
     <ul class="nav side-menu">
      ...
      @foreach($getData_arr as $getData)
        <li class="active">
          <a><i class="fa fa-th"></i> {{$getData['item_category_name']}} <span class="fa fa-chevron-down"></span></a>
          <ul class="nav child_menu" style="display: block;">
            @foreach($getData['sub_category_arr'] as $item_sub)
              <li><a href="{{url('admin/stock_mgr/actual_stock')}}?item_subcatID={{$item_sub['id']}}">{{$item_sub['name']}}</a></li>
            @endforeach
          </ul>
        </li>
        <?php 
