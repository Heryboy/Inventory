  ...
  $.purchaseDataAttribute = function(attribute_row){
    var html = '';
     html +='<tr id="attribute-row-item'+attribute_row+'">';
      html +='<td><div id="group_barcode'+attribute_row+'">{!! Form::text("barcode[]",null,["class"=>"form-control","id"=>"item_barcode","placeholder"=>trans("stock_mgr/purchase_order.entry_barcode")]) !!}</div></td>';
      html +='<td width="150px">';
      ...
      html +='<td id="group_qty'+attribute_row+'">';
        html += '<input name="qty[]" onblur="setTotal(' + attribute_row + ');" type="text" class="form-control" placeholder="{!!trans("stock_mgr/purchase_order.entry_price_quantity")!!}">';
      html += '</td>';
      ...
      html +='<td id="group_total'+attribute_row+'">{!! Form::text("total[]",null,["class"=>"form-control total","id"=>"total","placeholder"=>trans("stock_mgr/purchase_order.entry_price_total")]) !!}</td>';
