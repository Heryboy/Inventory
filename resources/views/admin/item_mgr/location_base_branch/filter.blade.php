...
<div class="group-filter">
  <div class="row padding-top">
    ...
    <div class="col-sm-9">
      <div class="row">
        <div class="col-sm-12">
          <form method="put" id="form-search" action="{{url('admin/item_mgr/location_base_branch/create')}}">
            <div class="col-sm-4">
    ...
    <div class="col-sm-3">
      <span class="pull-right">
        <a class="btn btn-sm btn-primary" href="{{url('admin/item_mgr/location_base_branch')}}"><i class="fa fa-wa fa-reply"></i> {{trans('item_mgr/item_base_store.back_to_list')}}</a>
