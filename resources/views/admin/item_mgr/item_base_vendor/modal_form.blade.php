  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @if(!isset($item_base_vendor))
          {!! Form::open(['url' => 'admin/item_mgr/item_base_vendor','id'=>'form-item','class'=>'form-horizontal']) !!}
        @else
                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="col-sm-12" style="padding-top:30px;">
                      ...
                      <div class="form-group item_category_group col-sm-6">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12 ">
                          {!! Form::text('item_category_name',null,['placeholder' => trans('setup_mgr/item.item_category'),'class'=>'form-control has-feedback-left']) !!}
                      ...
                      <div class="form-group item_type_group col-sm-6">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12 ">
                          {!! Form::text('item_type_name', null, ['placeholder' => trans('setup_mgr/item.item_type'),'class'=>'form-control has-feedback-left']) !!}
                          <span class="fa fa-group form-control-feedback left" aria-hidden="true"></span>
                      ...
                      <div class="form-group col-sm-6">
                        <label for="middle-name" class="-control-label col-sm-4 col-x pull-lefts-12">{!!trans('setup_mgr/item.item_alias')!!} </label>
                        <div class="col-md-8 col-sm-8 col-xs-12 ">
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                    <div class="col-sm-12" style="padding-top:20px;">
                      <!-- form-group -->
                      <div class="form-group col-sm-6">
                        <label for="middle-name" class="-control-label col-sm-4 col-x pull-lefts-12">{!!trans('setup_mgr/item.qty1')!!} </label>
                        <div class="col-md-8 col-sm-8 col-xs-12 ">
                      ...
                      <!-- form-group -->
                      <div class="form-group col-sm-6">
                        <label for="middle-name" class="-control-label col-sm-4 col-x pull-lefts-12">{!!trans('setup_mgr/item.qty2')!!} </label>
                        <div class="col-md-8 col-sm-8 col-xs-12 ">
                      ...
                      <!-- form-group -->
                      <div class="form-group col-sm-6">
                        <label for="middle-name" class="-control-label col-sm-4 col-x pull-lefts-12">{!!trans('setup_mgr/item.unit1')!!} </label>
                        <div class="col-md-8 col-sm-8 col-xs-12 ">
                      ...
                      <!-- form-group -->
                      <div class="form-group col-sm-6">
                        <label for="middle-name" class="-control-label col-sm-4 col-x pull-lefts-12">{!!trans('setup_mgr/item.unit2')!!} </label>
                        <div class="col-md-8 col-sm-8 col-xs-12 ">
