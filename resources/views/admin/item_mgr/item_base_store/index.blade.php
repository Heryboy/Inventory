                  ...
                  <div class="-row">
                    <span class="pull-right">
                      ...
                      <div class="btn-group pull-left">
                        <a data-original-title="{!! trans('item_mgr/item_base_store.assign') !!}"  data-toggle="tooltip" type="button" data-placement="top" href='{{url('admin/item_mgr/item_base_store/create')}}' class="btn btn-sm btn-primary" name="submit"><i class="fa fa-wa fa-pencil"></i> {!! trans('item_mgr/item_base_store.assign') !!}</a>
                    ...
                    <tbody>
                      @foreach($ItemBaseStores as $ItemBaseStore)
                        <tr class="even pointer">
                          ...
                          <td>{{$ItemBaseStore->item_code}}</td>
                          <td>{{$ItemBaseStore->category_name}}</td>
                          <td>{{$ItemBaseStore->sub_category_name}}</td>
                          <!-- <td>{{$ItemBaseStore->sub_category_name}}</td> -->
                          <td>{{$ItemBaseStore->created_at}}</td>
