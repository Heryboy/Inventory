...
@section('content')
                  ...
                  <div class="-row">
                    <span class="pull-right">
                      <div class="btn-group pull-left">
                        <button style="margin-right: 10px;" onclick="initPrintBarcode();" data-original-title="{!! trans('item_mgr/item_barcode.entry_print') !!}"  data-toggle="tooltip" type="button" data-placement="top" href='{{url('admin/item_mgr/item_base_store/create')}}' class="btn btn-sm btn-success" name="print"><i class="fa fa-wa fa-print"></i> {!! trans('item_mgr/item_barcode.entry_print') !!}</button>

                        <button form-id="form-barcode" data-original-title="{!! trans('item_mgr/item_barcode.entry_generate') !!}"  data-toggle="tooltip" type="submit" data-placement="top" href='{{url('admin/item_mgr/item_base_store/create')}}' class="btn btn-sm btn-primary" name="submit"><i class="glyphicon glyphicon-cog"></i> {!! trans('item_mgr/item_barcode.entry_generate') !!}</button>
                      </div>
                    </span>
                    <span class="pull-right">
                    </span>
  ...
  <script type="text/javascript">
    function initPrintBarcode(){
      ...
      var URL = "{{url('/')}}/admin/item_mgr/print_barcode?category_id="+cid+"&sub_category_id="+scid+"&font_family=Arial.ttf&font_size=10&type=barcodegen%2Fhtml%2FBCGcode128.php&filetype=PNG&dpi=72&scale=2&thickness=50&rotation=0&barcode_type=NULL";
      // window.print();
