...
<body>
	...
	<table id="example1" class="table table-bordered table-striped dataTable">
		<thead>
			...
			<th>{!!trans('report/sale_pos_receipt.entry_code')!!}</th>
			<th>{!!trans('report/sale_pos_receipt.entry_name')!!}</th>
			<th>{!!trans('report/sale_pos_receipt.entry_unit')!!}</th>
			<th>{!!trans('report/sale_pos_receipt.entry_sale_qty')!!}</th>
			<th>{!!trans('report/sale_pos_receipt.entry_void_qty')!!}</th>
			<th>{!!trans('report/sale_pos_receipt.entry_discount')!!}</th>
			<!-- <th>{!!trans('report/sale_pos_receipt.entry_tax')!!}</th> -->
			<th>{!!trans('report/sale_pos_receipt.entry_gross_sale')!!}</th>
			<th>{!!trans('report/sale_pos_receipt.entry_net_sale')!!}</th>
			<!-- <th>{!!trans('report/sale_pos_receipt.entry_cost_of_goods')!!}</th> -->
			<th>{!!trans('report/sale_pos_receipt.entry_margin')!!}</th>
			</tr>
		</thead>
		<tbody>
			<?php 
