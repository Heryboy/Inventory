...
@section('content')
  ...
  <form target="_blank" action="{{url('admin/report/print_purchase_order_by_supplier')}}" novalidate="" action="#" id="demo-form2" data-parsley-validate="" class="">
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              <div class="x_title">
                <div class="row">
                  <h2><i class="fa fa-wa fa-flag"></i> {!!trans('report/purchase_order.entry_purchase_order_by_supplier')!!}</h2>
                  <div class="clearfix"></div>
                </div>
              </div>
              {{-- filter --}}
              @include("admin.report.purchase_order_by_supplier.filter")
              ...
              <div class="row">
                ...
                <div class="x_content">
                  <table id="example1" class="table table-bordered table-striped dataTable">
                    ...
                    <tbody>
                      <?php $i = 1;?>
                      @foreach($purchaseOrderBySupplier as $row)
                        <tr>
                          <td>{{ $i }}</td>
