...
<body>
	...
	<div style="padding-top:10px;">
		...
		<div class="box-grid col-sm-3 col-xs-12">
			...
			<h4>Gross Sales: {{ number_format($total_gross_sale, 3) }} $</h4>
		...
		<div class="box-grid col-sm-3 col-xs-12">
			<div class="tile-stats">
			<!-- <div class="icon"><i class="fa fa-users"></i></div> -->
			<h4>Discounts: {{ number_format($total_discount, 3) }} $</h4>
			<!-- <p> <a href="{{url('admin/customer_mgr/customer')}}">View more customers ...</a></p> -->
			</div>
		</div>
		...
		<div class="box-grid col-sm-3 col-xs-12">
			<div class="tile-stats">
			<!-- <div class="icon"><i class="fa fa-users"></i></div> -->
			<h4>Net Sales: {{ number_format($total_netsale, 3) }} $</h4>
			<!-- <p> <a href="{{url('admin/customer_mgr/customer')}}">View more customers ...</a></p> -->
			</div>
		</div>
		...
		<div class="box-grid col-sm-3 col-xs-12">
			<div class="tile-stats">
			<!-- <div class="icon"><i class="fa fa-users"></i></div> -->
			<h4>Gross Profit: {{ number_format($total_cost_product, 3) }} $</h4>
			<!-- <p> <a href="{{url('admin/customer_mgr/customer')}}">View more customers ...</a></p> -->
			</div>
		</div>
		...
		<div class="box-grid col-sm-3 col-xs-12">
			<div class="tile-stats">
			<!-- <div class="icon"><i class="fa fa-users"></i></div> -->
			<h4>Taxes: {{ number_format($total_tax, 3) }} $</h4>
			<!-- <p> <a href="{{url('admin/customer_mgr/customer')}}">View more customers ...</a></p> -->
			</div>
		</div>
	</div>
