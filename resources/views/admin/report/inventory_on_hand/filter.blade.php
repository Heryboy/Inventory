...
<div class="group-filter">
  <div class="row padding-top">
    ...
    <div class="col-sm-12">
      <div class="row">
        <div class="col-sm-12">
          <form method="put" id="form-search" action="{{url('admin/report/inventory_on_hand')}}">
            
            <div class="col-sm-2">
              {{trans('report/inventory_on_hand.entry_branch')}}
              {!! Form::select('branch_id', $Branch, null, ['id'=>'branch_id','class'=>'form-control']) !!}
            </div>

            <div class="col-sm-3">
              {{trans('report/inventory_on_hand.entry_category')}}
            ...
            <div class="col-sm-3">
              {{trans('report/inventory_on_hand.entry_subcategory')}}
