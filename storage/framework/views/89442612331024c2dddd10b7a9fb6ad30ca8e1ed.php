...
<?php $__env->startSection('content'); ?>
  ...
  <div class="main_container">
    ...
    <?php echo Form::open(['url' => 'admin/users','files'=> true,'class'=>'form-horizontal']); ?>
                    ...
                    <div class="form-group">
                      <div class="col-sm-4">
                        <div style="position:relative;">
                          <!--e-logo-->
                          <div class="e-logo">
                            <img width="120px" src="<?php echo e(url('/images/no_image.png')); ?>" id="t" /> 
                  ...
                  <div class="col-sm-9">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                        <?php echo Form::text('username',null,['class'=>'form-control has-feedback-left','placeholder'=>'username']); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                        <?php echo Form::password('password',['class'=>'form-control has-feedback-left','placeholder'=>'Password']); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                        <?php echo Form::password('password_confirmation',['class'=>'form-control has-feedback-left','placeholder'=>'Confirm Password']); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                        <?php echo Form::email('email',null,['class'=>'form-control has-feedback-left','placeholder'=>'Email']); ?>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 ">
                              <?php echo Form::select('group_id', $user_groups, null, ['optional' => 'Select a user...','class'=>'form-control has-feedback-left']); ?>
