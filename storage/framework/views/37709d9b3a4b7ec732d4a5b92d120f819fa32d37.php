...
<body>  
    <div class="contain-invoice">
        ...
        <div class="bill-info">
            ...
            <div class="general-info">
                <span class="pull-left">
                    <div class="invoice-no"><?php echo e($Quotations['quotation_no']); ?></div>
                </span>
                <span class="pull-right">
        ...
        <table id="table-row">
                ...
                <?php if(isset($QuotationDetails)): ?>
                    <?php foreach($QuotationDetails as $row): ?>
                        <tr>
                            ...
                            <td><?php echo e(Helpers::FormatCurrentcy($row->quotation_price,'$')); ?></td>
                            <td><?php echo e($row->quotation_qty); ?></td>
                            <td><?php echo e(Helpers::FormatCurrentcy($row->quotation_price * $row->quotation_qty,'$')); ?></td>
                        </tr>
                    <?php endforeach; ?>
               <?php endif; ?>
            </tbody>
            ...
            <tfoot>
                <tr>
                    ...
                    <td><span class="pull-right"><span id="p_amount_sub_total"></span> <?php echo e(Helpers::FormatCurrentcy($Quotations['sub_total'],'$')); ?></span></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="2">Tax</td>
                    <td><span class="pull-left"></span> <span class="pull-right"><?php echo e(Helpers::FormatCurrentcy($Quotations['tax'],'$')); ?></span></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="2">Discount</td>
                    <td><span class="pull-left"></span> <span class="pull-right"><span id="p_discount_total"></span><?php echo e(Helpers::FormatCurrentcy($Quotations['discount'],'$')); ?></span></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td colspan="2">Total </td>
                    <td><span class="pull-right"><span id="p_amount_total" class="pull-right amount_total"></span> <?php echo e(Helpers::FormatCurrentcy($Quotations['grand_total'],'$')); ?></span></td>
                </tr>
            </tfoot>
        </table>
        <br/>
