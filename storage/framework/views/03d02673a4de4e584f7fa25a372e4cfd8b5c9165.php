      ...
      <div class="col-sm-12">
        <form method="put" id="form-search" action="<?php echo e(url('admin/item_mgr/item_base_store/create')); ?>">
          ...
          <div class="col-sm-3">
            ...
            <button form-id="form-itembasestore" type="submit" class="btn btn-sm btn-success"><i class="fa fa-wa fa-print"></i> <?php echo e(trans('report/return_item.entry_print')); ?></button>
          </div>
        </form>
      </div>
    </div>
