                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <center>
                                        ...
                                        <a href="<?php echo e(route('admin.sale_mgr.sale_order.edit',$row->id)); ?>" class="btn btn-xs btn-primary" data-original-title="<?php echo trans('sale_mgr/sale_order.add_payment'); ?>" data-toggle="tooltip" data-placement="top"><i class="fa fa-money"></i></a>
