...
<script type="text/javascript">
  ...
  $.purchaseDataAttribute = function(attribute_row){
    var html = '';
     html +='<tr id="attribute-row-item'+attribute_row+'">';
      html +='<td><div id="group_barcode'+attribute_row+'"><?php echo Form::text("barcode[]",null,["class"=>"form-control","disabled"=>"","id"=>"item_barcode","placeholder"=>trans("stock_mgr/purchase_order.entry_barcode")]); ?></div></td>';
      html +='<td width="150px">';
      ...
      html +='<td id="group_qty'+attribute_row+'">';
        html += '<input name="sale_order_qty[]" onblur="setTotal(' + attribute_row + ');" type="text" class="form-control" placeholder="<?php echo trans("stock_mgr/purchase_order.entry_price_quantity"); ?>">';
      html += '</td>';
      ...
      html +='<td id="group_total'+attribute_row+'"><?php echo Form::text("total_hidden[]",null,["disabled"=>"","class"=>"form-control total","id"=>"total","placeholder"=>trans("stock_mgr/purchase_order.entry_price_total")]); ?> <input name="total[]" type="hidden"/></td>';
  ...
  //       var item_id = $(this).val();
  //       $.ajax({
  //         url: "<?php echo e(url('admin/stock_mgr/getBarcode')); ?>",
  //         dataType: "json",
  //         timeout: 3000,
  //         data: {
  //           item_id: item_id,
