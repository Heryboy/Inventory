    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <form method="put" id="form-search" action="<?php echo e(url('admin/item_mgr/item_base_store/create')); ?>">
          ...
          <div class="col-sm-3">
            <?php echo e(trans('report/sale_pos_item_by_drawer.entry_branch')); ?>

            <?php echo Form::select('branch_id', $Branch, null, ['id'=>'branch_id','class'=>'form-control']); ?>

          </div>
          <div class="col-sm-3">
            <?php echo e(trans('report/sale_pos_item_by_drawer.entry_drawer')); ?>

            <?php echo Form::select('user_id', $users, $user_id, ['id'=>'user_id','class'=>'form-control']); ?>

          </div>
          <div class="col-sm-3">
            <?php echo e(trans('report/sale_pos_item_by_drawer.entry_from_date')); ?>

            <?php echo Form::text('from_date', $from_date, ['placeholder'=>'From Date','id'=>'from_date','class'=>'date-picker form-control']); ?>

          </div>
          <div class="col-sm-3">
            <?php echo e(trans('report/sale_pos_item_by_drawer.entry_to_date')); ?>
