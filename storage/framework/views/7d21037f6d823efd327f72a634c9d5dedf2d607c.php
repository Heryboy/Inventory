    ...
    <div class="row">
      <div class="col-sm-12">
        <form method="put" id="form-search" action="<?php echo e(url('admin/item_mgr/item_base_store/create')); ?>">
          ...
          <div class="col-sm-3">
            <?php echo e(trans('report/item_information_report.entry_branch')); ?>

            <?php echo Form::select('branch_id', $Branch, null, ['id'=>'branch_id','class'=>'form-control']); ?>

          </div>
          <div class="col-sm-3">
            <?php echo e(trans('report/item_information_report.entry_category')); ?>
          ...
          <div class="col-sm-3">
            <?php echo e(trans('report/item_information_report.entry_subcategory')); ?>
