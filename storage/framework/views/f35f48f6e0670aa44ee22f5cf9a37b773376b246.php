    ...
    <div class="row padding-top">
      <div>
        ...
        <?php /* <div class="col-sm-2">
          <button type="button" id="initSearch"  class="btn btn-sm btn-primary"><i class="fa fa-wa fa-search"></i> <?php echo trans('item_mgr/item_barcode.entry_filter'); ?></button>
        </div> */ ?>
      ...
      <div>
        <div class="col-sm-3">
          <div class="input-prepend input-group">
            ...
            <?php /* <a class="info explanation" href="#"><img src="info.gif" alt="Explanation" /></a> */ ?>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="input-prepend input-group">
            <span class="add-on input-group-addon"><i class="fa fa-list"></i></span>
            <?php echo Form::number('dpi',72,['required' => 'required','placeholder'=>'DPI','min'=>72,'max'=>300,'class'=>'form-control']); ?>
        ...
        <div class="col-sm-3">
          <div class="input-prepend input-group">
            <span class="add-on input-group-addon"><i class="fa fa-list"></i></span>
            <?php echo Form::number('scale',2,['required' => 'required','placeholder'=>'Scale','min'=>1,'max'=>4,'class'=>'form-control']); ?>
        ...
        <div class="col-sm-3">
          <div class="input-prepend input-group">
            <span class="add-on input-group-addon"><i class="fa fa-list"></i></span>
            <input class="form-control" placeholder="Thickness" id="thickness" name="thickness" value="<?php echo e($thickness); ?>" type="number" min="20" max="90" step="5" required="required">
          </div>
        </div>
