    ...
    var html = '';
     html +='<tr id="attribute-row-item'+attribute_row+'">';
      ...
      html +='<td id="group_qty'+attribute_row+'">';
        html += '<input name="quotation_qty[]" onblur="setTotal(' + attribute_row + ');" type="text" class="form-control" placeholder="<?php echo trans("stock_mgr/purchase_order.entry_price_quantity"); ?>">';
      html += '</td>';
