  ...
  $.purchaseDataAttribute = function(attribute_row){
    var html = '';
     html +='<tr id="attribute-row-item'+attribute_row+'">';
      ...
      // html +='<td id="group_total'+attribute_row+'"><?php echo Form::text("total[]",null,["class"=>"form-control total","placeholder"=>trans("stock_mgr/purchase_order.entry_price_total")]); ?></td>';
